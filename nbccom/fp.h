...
#ifdef MPX
#define VAL1MASK	0x000fffff		/* takes fraction part1 */
#define VAL2MASK	0xffffffff		/* takes fraction part2 */
#define SIGN1MASK	0x80000000	 	/* mask off sign */
#define HIDDEN1BIT	0x00100000		/* implied bit */
#define CARRY1BIT	0x00200000 << GBITS	/* carry bit */
#define NORM1MASK	0xfff00000 << GBITS	/* to normalize */
#define NORM1BIT	0x00100000 << GBITS	/* implied bit */
#define NBIT1		0x00100000		/* normalizing bit w/o GBITS */
...
#define V_BIT1		0x00200000		/* overflow bit */
...
#define INFINITY1 	0x7ff00000		/* double prec. infinity */
#define INFINITY2 	0x00000000		/* double prec. infinity */
#define NEGINFINITY1	0xfff00000		/* negative infinity */
#define NEGINFINITY2	0x00000000		/* negative infinity */
#define SNOTANUMBER	0x7f800000		/* single prec. NaN */
#define NOTANUMBER1	0x7ff80000		/* double prec. NaN */
#define NOTANUMBER2	0x00000000		/* double prec. NaN */
#define NEGNOTANUMBER1	0xfff80000		/* negative NaN */
#define NEGNOTANUMBER2	0x00000000		/* negative NaN */
#define NEGZERO1	0x80000000		/* negative zero */
#define NEGZERO2	0x00000000		/* negative zero */
#else
...
union fpnum {
	...
	struct fprep {
		...
		unsigned exp:EXPSIZE;			/* 11 bits */
#ifdef MPX
		unsigned long fracl1:FRACSIZE-32;	/* 20 bits */
		unsigned long fracl2:32;		/* 32 bits */
#else
		unsigned long long frac:FRACSIZE;	/* 52 bits */
#endif
	} bval;
	struct fltrep {
		unsigned sign:1;			/* 1 bit */
		unsigned exp:S_EXPSIZE;			/* 8 bit */
		unsigned long frac1:23;			/* 23 bits */
		unsigned long frac2:32;			/* 32 bits */
	} fbval;
	struct {

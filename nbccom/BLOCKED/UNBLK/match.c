...
#ifndef lint
static char *rcsid = "@(#) (Gould) $Header: /u/nbc/nbccom/RCS/match.c,v 1.1 1995/01/27 21:56:20 jbev Exp $";
#endif
...
mlmatch(subtree, target, subtarget) NODE   *subtree;

...
#ifndef lint
static char *rcsid = "@(#) (Gould) $Header: /u/nbc/nbccom/RCS/table.c,v 1.1 1995/01/27 21:56:20 jbev Exp $";
#endif
...
/* START NOREG_REG */
ASG DIV, INAREG|FOREFF|FORCC,		/* no reg entry */
    STAREG|SAREG, TFP,
    SAREG, TFP,
    2*NTEMP, RESCC|RLEFT,
	"	std	AR,A1\n	dvfZLP	AL,A1\n",
 
ASG DIV, INAREG|FOREFF|FORCC,		/* reg-reg entry */
    STAREG|SAREG, TFP,
    SAREG, TFP,
    0, RESCC|RLEFT,
	"	dvrfZLP	AR,AL\n",

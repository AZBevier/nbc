...
/* VARARGS1 */
void error(s,a1) char *s; int a1; { /* write out error comment */
...
void stagen(){ /* generate the states */
    ...
    /* it represents the magic moment when the mem0 array, */
    /* which has been holding the productions, starts to */
    /* hold item pointers, of a different type... */
    /* someday, alloc should be used to allocate all this */
    /* stuff... for now, we  accept that if pointers don't */
    /* fit in integers, there is a problem... */

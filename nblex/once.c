...
#ifndef lint
static char *rcsid2 = "@(#) (Gould) $Header: /bulk2/simhv/nbc-master/nblex/RCS/once.c,v 1.3 2019/03/11 22:01:08 jbev Exp $";
#endif /* lint */
...
FILE *fout = (FILE *)NULL, *errorf = (FILE *)NULL;
...
char *cname = NCFORM;
char *ratname = "/system/lib/nrform";
#else
char *cname = NCFORM;
char *ratname = "/usr/lib/lex/nrform";
#endif /* MPX */

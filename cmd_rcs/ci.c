...
/*
 * $Log: ci.c,v $
 * Revision 1.6  2021/07/09 23:43:55  jbev
 * Fix warning error.
 *
 * Revision 1.5  2021/07/09 20:41:46  jbev
 * Fix warning errors.
 *
 * Revision 1.4  1995/10/13 21:51:45  jbev
 * Fix misplaced endif.
 *
 * Revision 1.3  1995/08/02  17:41:45  jbev
 * Put ifdef on -I option.
 *
 * Revision 1.2  1995/04/18  00:32:55  jbev
 * Yet more mpx fixes.
 *
...
mainProg(ciId, "ci", "$Id: ci.c,v 1.6 2021/07/09 23:43:55 jbev Exp $")
{

...
/*
 * $Log: rcsfnms.c,v $
 * Revision 1.6  2021/07/09 20:41:46  jbev
 * Fix warning errors.
 *
 * Revision 1.5  1995/04/19 20:04:17  jbev
 * Correct CO mpx problems.
 *
 * Revision 1.4  1995/04/18  21:55:05  jbev
 * More mpx fixes.
 *
 * Revision 1.3  1995/04/18  21:19:35  jbev
 * Fix error codes for MPX.
 *
 * Revision 1.2  1995/04/18  19:27:12  jbev
 * Change direct string.
 *
...
libId(fnmsId, "$Id: rcsfnms.c,v 1.6 2021/07/09 20:41:46 jbev Exp $")
...
#ifdef MPX
	interesting = finptr || (errno!=EINVAL && errno!=ENOENT);
#else /* MPX */

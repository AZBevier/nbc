...
/*
 * $Log: ident.c,v $
 * Revision 1.4  2021/07/09 23:45:32  jbev
 * Fix warning errors.
 *
 * Revision 1.3  1995/04/20 02:19:13  jbev
 * Fix syntax error.
 *
 * Revision 1.2  1995/04/20  02:02:04  jbev
 * Correct options for MPX.
 *
...
mainProg(identId, "ident", "$Id: ident.c,v 1.4 2021/07/09 23:45:32 jbev Exp $")
...
#ifdef MPX
   if ((quiet = argc > 1 && ((strcmp("-q",argv[1])==0) || strcmp("-Q",argv[1])==0))) {
#else

...
/*
 * $Log: rlog.c,v $
 * Revision 1.3  2021/07/09 20:41:46  jbev
 * Fix warning errors.
 *
 * Revision 1.2  1995/04/20 01:27:57  jbev
 * Fix options for MPX.
 *
...
mainProg(rlogId, "rlog", "$Id: rlog.c,v 1.3 2021/07/09 20:41:46 jbev Exp $")
{
	static char const cmdusage[] =
#ifdef MPX
	"\nrlog usage: rlog -{bhLOt} -ddates -p[lockers] -rrevs -sstates -w[logins] -Vn file ...";
#else

...
/*
 * $Log: rcsmerge.c,v $
 * Revision 1.3  2021/07/09 23:49:27  jbev
 * Fix warning errors.
 *
 * Revision 1.2  1995/04/20 01:32:44  jbev
...
mainProg(rcsmergeId, "rcsmerge", "$Id: rcsmerge.c,v 1.3 2021/07/09 23:49:27 jbev Exp $")
{

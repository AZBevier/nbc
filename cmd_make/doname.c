/*~!doname.c*/
/* Name:  doname.c Part No.: _______-____r
 *
...
#ident	"$Id: doname.c,v 1.3 2021/07/06 21:47:12 jbev Exp $"
...
extern void fatal1();
extern void exetm();
extern void dynamicdep();
extern CHAIN appendq();
extern int any();
extern int get();
extern int suffix();
extern int sindex();
...
TIMETYPE *tval;
{
  ...
  LINEBLOCK lp1, lp2;
  char sourcename [1024], prefix [1024], temp [1024], concsuff [32];
  CHARSTAR pnamep, p1namep;
  CHAIN qchain;
  int found, onetime;
  CHARSTAR savenamep = (char *)0;
